                    ...
                    <div class="tf-product-info-list other-image-zoom">
                        <div class="tf-product-info-heading">
                            ...
                            <h3 class="product-infor-name mb-12">
                                Modern Comfort 3-Seater Fabric Sofa
                            </h3>
                            ...
                            <p class="product-infor-desc cl-text-2 mb-12">
                                Experience exceptional comfort and timeless style with the Modern Comfort 3-Seater
                                Fabric Sofa. Designed with premium upholstery, high-density foam cushions, and a sturdy
                                wooden frame, this sofa offers the perfect blend of durability and elegance. Its
                                contemporary design complements modern, minimalist, and traditional interiors, making it
                                an ideal centerpiece for your living room.
                            </p>
                        </div>
        ...
        <div class="tab-content">
            <div class="tab-pane active show" id="description" role="tabpanel">
                <div class="tab-content_desc tf-grid-layout md-col-2">
                    ...
                    <div class="box-desc">
                        ...
                        <ul class="list">
                            <li class="cl-text-2">- Solid Wood Frame, High-Density Foam, Premium Polyester Fabric
                                Upholstery, Metal Support Springs</li>
                            <li class="cl-text-2">- Designed in Italy</li>
                            <li class="cl-text-2">- Origin: Imported</li>
                            <li class="cl-text-2">- Manufacture: India</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="tab-pane" id="customer-reviews" role="tabpanel">
                <div class="product-desc_review write-cancel-review-wrap">
                    <div class="box-rating mb-0">
                        ...
                        <div>
                            <button type="button"
                                class="action btn-comment-review btn-cancel-review tf-btn animate-btn">
                                Cancel Review
                            </button>
                            ...
                            <div class="comment-list">
                                <div class="box-comment">
                                    ...
                                    <p class="comment_text text-body-1">
                                        I absolutely love this sofa! The cushions are firm yet comfortable, and the
                                        fabric feels premium. It fits perfectly in my living room and was very easy to
                                        assemble. Highly recommended for anyone looking for a modern sofa.
                                    </p>
                                    <div class="comment_reply">
                                        ...
                                        <p class="comment_text text-body-1">
                                            Thank you for your wonderful feedback! We're delighted to hear you're
                                            enjoying your new sofa. If you ever need assistance, our support team is
                                            always here to help.
                                        </p>
                                    </div>
                                </div>
                                <div class="box-comment">
                                    ...
                                    <p class="comment_text text-body-1">
                                        The build quality exceeded my expectations. The frame feels sturdy, the
                                        upholstery is soft, and the color matched the pictures perfectly. Delivery was
                                        on time and everything arrived in excellent condition.
                                    </p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="box-write-comment write-review-wrap">
                        <div class="head">
            ...
            <div class="tab-pane" id="shipping-returns" role="tabpanel">
                <div class="tab-content_desc desc-2 tf-grid-layout sm-col-2 xl-col-4">
                    <div class="box-desc">
                        <h5 class="desc_title">Hassle-Free Returns</h5>
                        <div class="desc_info">
                            <p class="cl-text-2">
                                Shop with confidence knowing that eligible products can be returned or replaced if they
                                arrive damaged, defective, or incorrect. Every sofa is carefully inspected before
                                dispatch to ensure it meets our quality standards.
                            </p>
                        </div>
                    </div>
                    <div class="box-desc">
                        <h5 class="desc_title">Shipping & Delivery</h5>
                        <div class="desc_info">
                            <p class="cl-text-2">
                                We provide fast and reliable shipping across India through trusted delivery partners.
                                Orders are usually processed within 24–48 hours and securely packed to ensure they
                                arrive safely at your doorstep.
                            </p>
                        </div>
                    </div>
                    <div class="box-desc">
                        <h5 class="desc_title">Delivery Timeline</h5>
                        <ul class="list">
                            <li class="cl-text-2">- Standard Delivery: 3–7 Business Days</li>
                            <li class="cl-text-2">- Metro Cities: 2–5 Business Days</li>
                            <li class="cl-text-2">- Remote Areas: 5–10 Business Days</li>
                            <li class="cl-text-2">- Shipped From: India</li>
                        </ul>
                    </div>
                    <div class="box-desc">
                ...
                <div class="tab-content_desc desc-3 d-grid">
                    <div class="box-desc">
                        ...
                        <p class="desc_info cl-text-2">
                            At Levora, we are committed to delivering premium-quality furniture. If your product arrives
                            damaged, defective, or different from what you ordered, you can request a return or
                            replacement within 7 days of delivery, subject to our return policy.
                        </p>
                    </div>
                    <div class="box-desc">
                        <h5 class="desc_title">Return Eligibility</h5>
                        <ul class="list">
                            <li class="cl-text-2">- Returns and replacements are accepted only for damaged, defective, or incorrect products.</li>
                            <li class="cl-text-2">- The product must be unused and returned in its original packaging with all accessories.</li>
                            <li class="cl-text-2">- Items damaged due to misuse, improper handling, or normal wear and tear are not eligible for return.</li>
                        </ul>
                    </div>
                    <div class="box-desc">
                        <h5 class="desc_title">Return Policies</h5>
                        <ul class="list">
                            <li class="cl-text-2">
                                - Submit a return request through your account or contact our customer support team.
                            </li>
                            <li class="cl-text-2">
                                - Once approved, our logistics partner will arrange a pickup from your location.
                            </li>
                            <li class="cl-text-2">
                                - After the returned product passes inspection, your refund or replacement will be processed within 5–7 business days.
                            </li>
                        </ul>
                    </div>
                </div>
