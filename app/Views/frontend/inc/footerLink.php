<?= view('frontend/inc/footer') ?>
    ...
    <script src="<?=base_url('public/assets/template/');?>assets/js/plugin/bootstrap.min.js"></script>
    <script src="<?=base_url('public/assets/template/');?>assets/js/plugin/jquery.min.js"></script>
    ...
    <script src="<?=base_url('public/assets/template/');?>assets/js/carousel.js"></script>
    <script src="<?=base_url('public/assets/template/');?>assets/js/main.js"></script>
