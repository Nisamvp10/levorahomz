                            ...
                            <div class="swiper-slide">
                                <div class="box-icon_V01 features-main wow fadeInLeft text-white">
                                    <span class="icon">
                                        ...
                                        <img src="<?=base_url('public/assets/template/');?>assets/images/icon/14-day-returns.svg">
                                    </span>
                                    <div class="content">
                            ...
                            <div class="swiper-slide">
                                <div class="box-icon_V01 features-main wow fadeInLeft text-white">
                                    <span class="icon">
                                        ...
                                        <img src="<?=base_url('public/assets/template/');?>assets/images/icon/fast-secure-delivery.svg">
                                    </span>
                                    <div class="content">
                            ...
                            <div class="swiper-slide">
                                <div class="box-icon_V01 features-main wow fadeInLeft text-white">
                                    <span class="icon">
                                        ...
                                        <img src="<?=base_url('public/assets/template/');?>assets/images/icon/sustainable-design.svg">
                                    </span>
                                    <div class="content">
                            ...
                            <div class="swiper-slide">
                                <div class="box-icon_V01 features-main wow fadeInLeft text-white">
                                    <span class="icon">
                                        ...
                                        <img src="<?=base_url('public/assets/template/');?>assets/images/icon/trusted-by-customers.svg">
                                    </span>
                                    <div class="content">
            ...
            <div class="d-flex justify-content-center border-end">
                <div class="tf-currencies">
                    <select class="tf-dropdown-select style-default type-currencies">
                        <option selected data-thumbnail="<?= base_url('public/assets/template/assets/images/country/us.png');?>">(USD ₹)</option>
                        <option data-thumbnail="<?= base_url('public/assets/template/assets/images/country/vn.png');?>">(VND ₫)</option>
                    </select>
                </div>
            </div>
