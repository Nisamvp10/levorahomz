                                ...
                                Sofa
                                    ...
                                    <div class="product-infor-price mb-12">
                                        ...
                                        <p class="cl-text-3 text-decoration-line-through">
                                            <?= money_format_custom($price['actual_price']); ?></p>
                                    ...
                                    <div class="card-product">
                                        <div class="card-product_wrapper">
                                            ...
                                            <ul class="product-action_list">
                                                ...
                                                <li>
                                                    <a href="#quickView" data-id="<?= $items['id']; ?>"
                                                        ...
                                                        if ($item['compare_price'] > 0) {
                                                            for ($i = 8; $i > 0; $i++) {
                                                                ...
                                                                <div class="marquee-child-item">
                                                                    HOT SALE <?= $discount; ?>
                                                                    <?= ($item['price_offer_type'] == 1 ? 'RS' : '%'); ?> OFF
                                                                </div>
                                        ...
                                        <div class="card-product_info">
                                            ...
                                            <div class="price-wrap">
                                                <span class="price-new text-primary fw-semibold">
                                                    <?= money_format_custom($offerPrice) ?></span>
                                                <span class="price-old text-caption-01 cl-text-3">
                                                    <?= money_format_custom($actualPrice) ?></span>
                                            </div>
