...
/* Styling for the Pavizham logo (class "pa") */
.pa {
  width: 80px;      /* Adjust size to make it "small" as requested */
  height: auto;
  margin-bottom: -10px; /* Adds a little space between the two logos */
}

/* Ensures the Robin Food link/logo also behaves as a block */
.header-logo {
